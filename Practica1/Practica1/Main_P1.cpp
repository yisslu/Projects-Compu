...
int main() {
	...
	float vertices[] = {
		...
		0.53f,-0.43f,0.0f, 0.431f,0.815f,0.968f,//D1 Cian
		0.32f, -0.65f, 0.0f, 0.431f,0.815f,0.968f,//E1
		0.75f, -0.65f, 0.0f, 0.431f,0.815f,0.968f,//F 
		...
		0.28f, -0.81f, 0.0f, 0.816f,0.816f,0.823f, //H1
		0.43f, -0.65f, 0.0f, 0.816f,0.816f,0.823f, //I1
		0.59f, -0.65f, 0.0f, 1.0f,0.76f,0.058f,//L Amarillo
		0.59f, -0.81f, 0.0f, 1.0f,0.76f,0.058f, //K
		0.43f, -0.65f, 0.0f, 1.0f,0.76f,0.058f, //I2
		0.43f, -0.81f, 0.0f, 1.0f,0.76f,0.058f, // J1 
		0.75f, -0.65f, 0.0f, 1.0f,0.0f,0.0f,//F1 Rojo
		0.59f, -0.65f, 0.0f, 1.0f,0.0f,0.0f,//L1 
		0.59f, -0.81f, 0.0f, 1.0f,0.0f,0.0f,//K1
		0.90f, -0.65f, 0.0f, 0.686f,0.666f,0.827,// M Lila
		0.75f, -0.81f, 0.0f, 0.686f,0.666f,0.827, //N
		0.75f, -0.65f, 0.0f, 0.686f,0.666f,0.827,//F2 
		0.59f, -0.81f, 0.0f, 0.686f,0.666f,0.827,//K2
	...
	while (!glfwWindowShouldClose(window))
	{
	    ...
	    glDrawElements(GL_TRIANGLES,54, GL_UNSIGNED_INT, (GLvoid*)(0*sizeof(GLfloat)));
