...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform3f(lightPosLoc, lightPos.x + movelightPosx, lightPos.y + movelightPos, lightPos.z + movelightPosz);
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.diffuse"), 0.99f, 0.91f, 0.11f);
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.ambient"), 0.1f, 0.1f, 0.1f);
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.diffuse"), 0.12f, 0.59f, 0.94f);
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.diffuse"), 1.0f, 0.4f, 0.16f);
        ...
        model = glm::mat4(1.0f);
        model = glm::translate(model, glm::vec3(movelightPosx,movelightPos,movelightPosz));
