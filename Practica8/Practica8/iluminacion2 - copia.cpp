...
glm::vec3 SpotLightPos(5.0f, 0.0f, -5.0f);
glm::vec3 SpotLightDir(1.0f, 0.0f, 0.0f);
...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform1f(glGetUniformLocation(lightingShader.Program, "pointLights[3].linear"), 0.4f);
