...
int main() {
 ...
 void Inputs(GLFWwindow *window) {
	 ...
	 if (glfwGetKey(window, GLFW_KEY_LEFT) == GLFW_PRESS)
		 rot -= 0.09f;
	 if (glfwGetKey(window, GLFW_KEY_R) == GLFW_PRESS and hombro <= 45.0f)
		 hombro += 0.07f;
	 if (glfwGetKey(window, GLFW_KEY_F) == GLFW_PRESS and hombro >= -90.0f)
		 hombro -= 0.07f;
	 if (glfwGetKey(window, GLFW_KEY_T) == GLFW_PRESS and codo <=0.0f)
		 codo += 0.07f;
	 if (glfwGetKey(window, GLFW_KEY_G) == GLFW_PRESS and codo >= -145.0f)
		 codo -= 0.07f;
	 if (glfwGetKey(window, GLFW_KEY_Y) == GLFW_PRESS and muneca <= 15.0f)
		 muneca += 0.07f;
	 if (glfwGetKey(window, GLFW_KEY_H) == GLFW_PRESS and muneca >= -20.f)
		 muneca -= 0.07f;
	 if (glfwGetKey(window, GLFW_KEY_U) == GLFW_PRESS and dedo1 <= 15.0f)
		 dedo1 += 0.07f;
	 if (glfwGetKey(window, GLFW_KEY_J) == GLFW_PRESS and dedo1 >= -55.0f)
		 dedo1 -= 0.07f;
	 if (glfwGetKey(window, GLFW_KEY_I) == GLFW_PRESS and dedo2 <= 0)
		 dedo2 += 0.07f;
	 if (glfwGetKey(window, GLFW_KEY_K) == GLFW_PRESS and dedo2 >= -100.f)
		 dedo2 -= 0.07f;
 }
